...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<a [routerLink]=\"['/new']\">Add an author</a>\n\n<h4>We have quotes by:</h4>\n<table>\n    <thead>\n        <tr>\n            <th>Author</th>\n            <th>Actions Available</th>\n        </tr>\n    </thead>\n    <tbody>\n        <tr *ngFor=\"let a of authors\">\n            <td>{{a.name}}</td>\n            <td><button [routerLink]=\"['/edit/',a._id]\">Edit</button><button (click)='onDeleteClick(a)'>Delete</button></td>\n        </tr>\n    </tbody>\n</table>\n\n");

/***/ }),

/***/ "./node_modules/raw-loader/dist/cjs.js!./src/app/new-form/new-form.component.html":
/*!****************************************************************************************!*\
  !*** ./node_modules/raw-loader/dist/cjs.js!./src/app/new-form/new-form.component.html ***!
  \****************************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<a [routerLink]=\"['']\">Home</a>\n<p class='text-danger'>{{errorName}}</p>\n<form (submit)='onNewAuthor()'>\n    <label>Name: <input type=\"text\" name=\"newAuthor.name\" [(ngModel)]='newAuthor.name'></label>\n    <button type=\"submit\">Submit</button>\n</form>\n<button [routerLink]=\"['']\">Cancel</button>\n");
...
/* harmony import */ var _new_form_new_form_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./new-form/new-form.component */ "./src/app/new-form/new-form.component.ts");
...
const routes = [
    ...
    { path: 'new', component: _new_form_new_form_component__WEBPACK_IMPORTED_MODULE_1__["NewFormComponent"] },
...
let AppComponent = class AppComponent {
    ...
    onNewAuthor() {
        this._httpService.addAuthor(this.newAuthor)
            ...
            if (data.errors && data.errors.quote) {
                this.errorQuote = data.errors.quote.message;
            }
    ...
    onEditSubmit() {
        this._httpService.updateAuthor(this.updateAuthor)
            .subscribe(data => {
            console.log('Got data from post back', data);
    ...
    onDeleteClick(author) {
        this._httpService.deleteAuthor(author)
            .subscribe(data => {
...
/* harmony import */ var _new_form_new_form_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./new-form/new-form.component */ "./src/app/new-form/new-form.component.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _new_form_new_form_component__WEBPACK_IMPORTED_MODULE_8__["NewFormComponent"],
...
let EditComponent = class EditComponent {
    ...
    ngOnInit() {
        ...
        // })
        // this.updateAuthor = {_id:this.a._id, name: this.a.name}
        this.authorToEdit();
    }
    goHome() {
    ...
    authorToEdit() {
        this._route.params.subscribe((params) => {
            this._httpService.getAuthorId(params['id'])
                .subscribe(data => {
                this.author = data;
...
], EditComponent.prototype, "a", void 0);
...
let HttpService = class HttpService {
    ...
    deleteAuthor(author) {
        return this._http.delete(`/remove/${author._id}`, author);
    }
};
...
let ListComponent = class ListComponent {
    ...
    authorToEdit(author) {
        this._httpService.getAuthorId(author)
            .subscribe(data => {
            this.author = data;
            console.log(this.author);
        });
...
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], ListComponent.prototype, "authors", void 0);
...
/***/ "./src/app/new-form/new-form.component.scss":
/*!**************************************************!*\
  !*** ./src/app/new-form/new-form.component.scss ***!
  \**************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL25ldy1mb3JtL25ldy1mb3JtLmNvbXBvbmVudC5zY3NzIn0= */");
...
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], NewFormComponent.prototype, "newAuthor", void 0);
NewFormComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-new-form',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./new-form.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/new-form/new-form.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./new-form.component.scss */ "./src/app/new-form/new-form.component.scss")).default]
    })
], NewFormComponent);
...
module.exports = __webpack_require__(/*! /Users/zacharybryant/Documents/CodingDojo/mean_stack/mean/Angular/authors/public/src/main.ts */"./src/main.ts");
